        ...
        >
          ...
          <div className="px-4 py-2">
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto">
                  {mockBrands.map((brand) => (
                    <label key={brand.id} className="flex items-center">
                      ...
                      <span className="ml-auto text-gray-500 text-sm">({brand.count})</span>
                    </label>
                  ))}
                </div>
              </FilterSection>
                ...
                <div className="space-y-2">
                  {[5, 4, 3, 2, 1].map((rating) => (
                    <button
                      ...
                      className={`flex items-center w-full p-1.5 rounded-md transition-colors ${
                        selectedRating === rating ? 'bg-primary-50 text-primary-700' : 'hover:bg-gray-50'
                      }`}
                    >
            ...
            <div className="sticky bottom-0 bg-white py-4 border-t mt-6">
              <button
                onClick={() => setIsMobileFiltersOpen(false)}
                className="w-full py-2.5 px-4 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700"
              >
                Apply Filters
              </button>
            </div>
