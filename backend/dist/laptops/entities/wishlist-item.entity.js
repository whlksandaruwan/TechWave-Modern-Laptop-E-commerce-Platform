...
const laptop_entity_1 = require("./laptop.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => laptop_entity_1.Laptop, { onDelete: 'CASCADE' }),
    __metadata("design:type", laptop_entity_1.Laptop)
], WishlistItem.prototype, "laptop", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], WishlistItem.prototype, "laptopId", void 0);
